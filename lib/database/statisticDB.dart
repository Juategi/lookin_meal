...
class DBServiceStatistic{
  ...
  Future addVisit(String restaurant_id) async{
    var response = await http.post(
        "${StaticStrings.api}/visits", body: {"user_id" : DBServiceUser.userF.uid, "restaurant_id":restaurant_id});
    print(response.body);
  }
  ...
  Future addRate(String restaurant_id, String entry_id, bool withcomment) async{
    var response = await http.post(
        "${StaticStrings.api}/rates", body: {"user_id" : DBServiceUser.userF.uid, "restaurant_id":restaurant_id, "entry_id" : entry_id, "withcomment" : withcomment.toString()});
    print(response.body);
  }
