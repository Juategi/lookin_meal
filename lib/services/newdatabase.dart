...
class DBServiceN{
  ...
  Future createUser(String id, String email, String name, String picture, String service) async {
    ...
    var response = await http.post("https://lookinmeal-dcf41.firebaseapp.com/users", body: body);
    print(response.body);
  }

  Future updateUserData(String id, String email, String name, String picture, String service) async {
    Map body = {
      "id" :id,
      "name":name,
      "email":email,
    ...
    var response = await http.put("https://lookinmeal-dcf41.firebaseapp.com/users", body: body);
    print(response.body);
  }
