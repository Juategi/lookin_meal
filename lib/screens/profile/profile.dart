                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text("${DBServiceUser.userF.ratings.length} ${tr.translate("ratings")}", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.normal, fontSize: ScreenUtil().setSp(16),),)),
                        Row(
                            children: [
                              ...
                              Text(tr.translate("followers"), maxLines: 1, textAlign: TextAlign.start, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.normal, fontSize: ScreenUtil().setSp(16),),)),
                              SizedBox(width: 10.w,),
                              ...
                              Text(tr.translate("following"), maxLines: 1, textAlign: TextAlign.start, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.normal, fontSize: ScreenUtil().setSp(16),),)),
                            ]
                        ),
                      ],
                    )
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("edituser"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("fav"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                          Text(">", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("reservations"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                          Text(">", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("mynot"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                          Text(">", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("areupropietary"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                          Text(">", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("helpsupport"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                          Text(">", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                        ],
                      ),
                    ),
                          ...
                          child: Dialog(
                            ...
                            child: Container(
                              ...
                              child: Column( mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Container(width: 230.w, height: 50.h,  child: Text(tr.translate("surelogout"), maxLines: 2, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.white, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                                  SizedBox(height: 20.h,),
                                  GestureDetector(
                                    onTap: (){
                                      _auth.signOut();
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Text(tr.translate("logout"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.white, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                                        ],
                                      ),
                                    ),
                                  ),
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Text(tr.translate("cancel"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.white, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                                        ],
                                      ),
                                    ),
                                  ),
                    ...
                    child: Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(width: 30.w,),
                          Container(width: 250.w, child: Text(tr.translate("logout"), maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),))),
                          Text(">", maxLines: 1, style: GoogleFonts.niramit(textStyle: TextStyle(color: Colors.black, letterSpacing: .3, fontWeight: FontWeight.bold, fontSize: ScreenUtil().setSp(18),),)),
                        ],
                      ),
                    ),
